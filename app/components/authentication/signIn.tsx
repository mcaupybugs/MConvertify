    ...
    return (
        <div className='flex flex-col w-full mt-6'>
            ...
            <div className='flex flex-row w-full h-full mt-4'>
                ...
                <p className='h-full text-xs ml-2'>Remember Me</p>
                </div>
            ...
            <div className='w-full h-full'>
                <button className='w-full h-full bg-slate-400'>Sign In</button>
            </div>
            <hr className='border-2 m-8 border-black border-solid'></hr>
        </div>
    )
}
